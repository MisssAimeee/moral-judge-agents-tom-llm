...
Updated 2026-07-28 after jobs `19030249` (checkpoint factorial rescore), `19027795`
(v3 probe-side refresh) and `19094832` (W3 causal steering) completed.
...
| W3 — Causal steering | complete | **19094832** (19092342 quarantined: broken coherence detector) | v3; OLMo-2-7B-I + Qwen2.5-7B-I |
